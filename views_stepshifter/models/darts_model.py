...
class XGBRFModel(RegressionModel, _LikelihoodMixin):
    def __init__(
        self,
        ...
        **kwargs
        ...
        super().__init__(
            ...
            model=xgb.XGBRFRegressor(**self.kwargs),
...
class XGBRFClassifierModel(RegressionModel, _LikelihoodMixin):
    def __init__(
        self,
        lags: Optional[LAGS_TYPE] = None,
        lags_past_covariates: Optional[LAGS_TYPE] = None,
        ...
        **kwargs
        ...
        super().__init__(
            ...
            add_encoders=add_encoders,
            multi_models=multi_models,
            model=xgb.XGBRFClassifier(**self.kwargs),
            use_static_covariates=use_static_covariates,
        )
...
class XGBClassifierModel(RegressionModel, _LikelihoodMixin):
    def __init__(
        self,
        lags: Optional[LAGS_TYPE] = None,
        lags_past_covariates: Optional[LAGS_TYPE] = None,
        ...
        **kwargs
        ...
        super().__init__(
            ...
            add_encoders=add_encoders,
            multi_models=multi_models,
            model=xgb.XGBClassifier(**self.kwargs),
            use_static_covariates=use_static_covariates,
        )
...
class LightGBMClassifierModel(RegressionModelWithCategoricalCovariates, _LikelihoodMixin):
    def __init__(
        self,
        lags: Optional[LAGS_TYPE] = None,
        lags_past_covariates: Optional[LAGS_TYPE] = None,
...
class RandomForestClassifierModel(RegressionModel):
    def __init__(
        self,
        lags: Optional[LAGS_TYPE] = None,
        lags_past_covariates: Optional[LAGS_TYPE] = None,
